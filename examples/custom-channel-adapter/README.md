...
This package is a **minimal pattern reference** for implementing CAP’s `ChannelIngress` contract in your own integration. It is **not** a real Discord client or Gateway listener; it only shows how to:
...
- Run **`@cap/adapter-conformance`** so your adapter stays aligned with the frozen contract harness
