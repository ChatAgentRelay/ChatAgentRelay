...
They exist to provide a stable schema-consumption and contract-test baseline for the seven-event happy path described by the public CAR architecture and schema documents.
